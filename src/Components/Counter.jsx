...
// El componente Counter recibe dos props: initialValue e increment.
...
const directionRef = useRef("");
 ...
 // useEffect se usa para imprimir el valor actual del contador en la consola
useEffect(()=>{
            console.log(`The value of the counter is ${counter}`)
          //   return () => {
          //   console.log(`The value of the counter was ${counter}`)
          // };
},[counter]); // El array [counter] indica que el efecto solo se ejecutará cuando counter cambie.
